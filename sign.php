...
$email_pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$";
		...
		$query1="select * from signin where email = '$email'";
		$result1=mysqli_query($con, $query1) or die(mysqli_error($con));
		$total_s=mysqli_num_rows($result1);

	if($total_s == 0)
	{
		$user_reg="insert into signin(name,email,password,contact,city,address) values('$name','$email','$pass','$contact','$city','$address')";
...
<body>
		...
		<div align="center">
			<a href="signin.php" class="btn btn-primary" type="submit" name="button">Try Signing Up again</a>						
		</div>
</body>
</html>
<?php
